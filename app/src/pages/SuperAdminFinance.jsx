    ...
    <RefreshCw size={20} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-2xl shadow-xl border-b-4 border-green-600">
          ...
          <h3 className="text-3xl font-black text-green-700">{formatCedi(stats.total)}</h3>
        </div>
        <div className="bg-white p-6 rounded-2xl shadow-xl border-b-4 border-blue-600">
          ...
          <h3 className="text-3xl font-black text-blue-700">{formatCedi(stats.physical)}</h3>
        </div>
        <div className="bg-white p-6 rounded-2xl shadow-xl border-b-4 border-purple-600">
          ...
          <h3 className="text-3xl font-black text-purple-700">{formatCedi(stats.digital)}</h3>
        </div>
      </div>
